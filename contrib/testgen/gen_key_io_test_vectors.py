...
bech32_templates = [
  ...
  ('lit',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('lit',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('lit',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tlit',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tlit',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tlit',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rlit',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rlit',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rlit', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tlit',  17, 32, False, False, False),
  ('rlit',  3,  1, False, False, False),
  ('lit',   15, 41, False, False, False),
  ('tlit',  0, 16, False, False, False),
  ('rlit',  0, 32, True,  False, False),
  ('lit',   0, 16, True,  False, False),
  ('tlit',  0, 32, False, True,  False),
  ('rlit',  0, 20, False, False, True)
]
