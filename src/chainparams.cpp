...
{
    const char* pszTimestamp = "Provigen Networks: Now accepting Lightcoins 13/Feb/2019"; //2020
...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000000000000132f258a65");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xd2a13ecda7efe42e509f13a32d2fa0ff2197cdccfcab4b9e075e7888897f5bb0"); //9884
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x75eae30ac2fb12ca109566c43134d9043b63f5b79b3f7fc4aa388803ea25ff67"));
        assert(genesis.hashMerkleRoot == uint256S("0xef61a8548b446f8bbdb5fa8f2e4df20b54b5f727fccf59a0fdb42311dbcfd99c"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x53, 0x54, 0x41, 0x52};
        base58Prefixes[EXT_SECRET_KEY] = {0x4d, 0x49, 0x4e, 0x45};
        ...
        checkpointData = {
            {
                {  1250, uint256S("0xc071cf20f2e0895c6d4f8e31240b101e1e4769a9d85b8d7e68127f6a5c1547e9")},
                {  5000, uint256S("0xef6fba187e901d01b2ab484fa5b807fce1c03eb4beefce0a7465a514d0d27a2a")},
                {  9884, uint256S("0xd2a13ecda7efe42e509f13a32d2fa0ff2197cdccfcab4b9e075e7888897f5bb0")},
        ...
        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 4096 d2a13ecda7efe42e509f13a32d2fa0ff2197cdccfcab4b9e075e7888897f5bb0
            /* nTime    */ 1582762699,
            /* nTxCount */ 39885,
            /* dTxRate  */ 0.999898836621143
        };
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 613607, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd84378813d30926d29d38575a9b9d9724a49f12a5657c01e692ee50dba273b4f"));
        assert(genesis.hashMerkleRoot == uint256S("0xef61a8548b446f8bbdb5fa8f2e4df20b54b5f727fccf59a0fdb42311dbcfd99c"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.lightcointools.com");
        vSeeds.emplace_back("seed-b.lightcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7c7217826bf588d03b0c03fded765f4c845bfc41a0329a433ded5f981c4a4161"));
        assert(genesis.hashMerkleRoot == uint256S("0xef61a8548b446f8bbdb5fa8f2e4df20b54b5f727fccf59a0fdb42311dbcfd99c"));
