...
const char * const BITCOIN_CONF_FILENAME = "litercoin.conf";
const char * const BITCOIN_PID_FILENAME = "litercoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Litercoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Litercoin";
#else
    // Unix
