...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " litercoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  litercoin-tx [options] <hex-tx> [commands]  Update hex-encoded litercoin transaction\n" +
            "or:     litercoin-tx [options] -create [commands]   Create hex-encoded litercoin transaction\n" +
            "\n";
