...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s litercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  litercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded litercoin transaction") + "\n" +
              "  litercoin-tx [options] -create [commands]   " + _("Create hex-encoded litercoin transaction") + "\n" +
              "\n";
