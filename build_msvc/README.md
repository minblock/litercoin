...
Dependencies
---------------------
A number of [open source libraries](https://github.com/minblock/litecoin/blob/master/doc/dependencies.md) are required in order to be able to build Litercoin.
