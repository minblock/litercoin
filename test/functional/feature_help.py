...
"""Verify that starting lightcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start lightcoin with -h for help text")
        ...
        self.log.info("Start lightcoin with -version for version information")
        ...
        self.log.info("Start lightcoind with -fakearg to make sure it does not start")
