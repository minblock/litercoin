...
"""Verify that starting litercoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start litercoin with -h for help text")
        ...
        self.log.info("Start litercoin with -version for version information")
        ...
        self.log.info("Start litercoind with -fakearg to make sure it does not start")
