...
* Update manpages, see [gen-manpages.sh](https://github.com/minblock/lightcoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/minblock/gitian.sigs.lit.git
    git clone https://github.com/minblock/lightcoin-detached-sigs.git
...
- Detached signatures will then be committed to the [lightcoin-detached-sigs](https://github.com/minblock/lightcoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the-light.pgn.one server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the-light.pgn.one server.

```
- Update-light.pgn.one version
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/minblock/lightcoin/releases/new) with a link to the archived release notes.
