# Support for Output Descriptors in Lightercoin Core

Since Lightercoin Core v0.17, there is support for Output Descriptors. This is a
...
on Lightercoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Lightercoin Core wallets, a convenience function `combo` is
