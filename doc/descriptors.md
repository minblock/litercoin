# Support for Output Descriptors in Lightcoin Core

Since Lightcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `lit1...` for mainnet or `tlit1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Lightcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Lightcoin Core wallets, a convenience function `combo` is
