# Support for Output Descriptors in Litercoin Core

Since Litercoin Core v0.17, there is support for Output Descriptors. This is a
...
on Litercoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Litercoin Core wallets, a convenience function `combo` is
