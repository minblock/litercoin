Litercoin Core version *0.15.1* is now available from:

  <https://download.litercoin.org/litercoin-0.15.1/>
...
A number of changes to the way Litercoin Core deals with peer connections and invalid blocks
