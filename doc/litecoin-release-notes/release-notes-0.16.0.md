Lightercoin Core version 0.16.0 is now available from:
...
Lightercoin Core now has more flexibility in where the wallets directory can be
...
------------------------------------
The minimum version of the GCC compiler required to compile Lightercoin Core is now 4.8. No effort will be
...
- #482 `5c8e26d` Lightercoin: Basic changes for v0.16 release (thrasher-)
