Litercoin Core version 0.17.1 is now available from:
...
prefixing the option with the network, such as:
    ...
    main.uacomment=litercoin
    test.uacomment=litercoin-testnet
...
be used in V0.17 by starting litercoind with the '-deprecatedrpc=accounts'
...
BIP 174 Partially Signed Litercoin Transactions support
-----------------------------------------------------
